    ...
    <section class="bg-white ">
      <div class="container px-6 py-10 mx-auto">
        <div className="text-center">
          <Subtitle>THE SHOWRUNNERS</Subtitle>
          <Title>Perfect Team</Title>
        </div>

        <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-2">
          <div class="px-12 py-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-primary ">
            <div class="flex flex-col sm:-mx-4 sm:flex-row">
              ...
              <div class="mt-4 sm:mx-4 sm:mt-0">
                <h1 class="text-xl font-semibold text-gray-700 capitalize md:text-2xl  group-hover:text-white">
                  arthur melo
                </h1>
            ...
            <p class="mt-4 text-gray-500 capitalize group-hover:text-gray-300">
