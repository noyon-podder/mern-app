    ...
    <section class="bg-white ">
      <div class="container px-6 py-12 mx-auto">
        <div class="text-center">
          <Subtitle>Our friendly team is always here to chat.</Subtitle>
        ...
        <div class="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
          <div class="flex flex-col items-center justify-center text-center">
            <span class="p-3 text-primary rounded-full bg-orange-100/80 ">
              <svg
            ...
            <p class="mt-2 text-primary ">noyon.podder7@gmail.com</p>
          </div>
          ...
          <div class="flex flex-col items-center justify-center text-center">
            ...
            <p class="mt-2 text-primary ">+880 1752441505</p>
          </div>
        </div>
      </div>
    </section>
