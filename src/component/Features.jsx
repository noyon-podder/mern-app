          ...
          <div class="lg:flex lg:items-center">
            <div class="w-full space-y-12 lg:w-1/2 ">
              ...
              <div class="md:flex md:items-start md:-mx-4">
                <span class="inline-block p-2 text-primary bg-orange-100 rounded-xl md:mx-4 ">
                  <svg
                ...
                <div class="mt-4 md:mx-4 md:mt-0">
                  ...
                  <p class="mt-3 text-gray-500">
                    Dynamically synthesize e-business e-business for unique
                    metrics. Energistically cultivate technically sound
                    e-services with vertical human capital. Objectively
                    administrate best-of-breed partnerships.
                  </p>
                </div>
              </div>
